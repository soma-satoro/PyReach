...
urlpatterns = [
    ...
    path("api/scenes/invite-candidates/", views.api_scene_invite_candidates, name="api_scene_invite_candidates"),
    path("api/characters/<int:character_id>/sheet/", views.api_character_sheet, name="api_character_sheet"),
    path("api/commands/execute/", views.api_command_execute, name="api_command_execute"),
    ...
    path("api/scenes/<int:scene_id>/invite/", views.api_scene_invite, name="api_scene_invite"),
